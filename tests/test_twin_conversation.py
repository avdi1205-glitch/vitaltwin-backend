...
class TestSourceTypeLabels:
    def test_every_allowed_type_has_a_german_label(self):
        for source_type in ["user_reported", "trend", "google_health", "cgm", "nutrition", "confirmed_memory", "pattern", "biomarker", "twin_history", "general_wellness_info", "uncertain", "needs_more_data"]:
